---
title: FAMBOX Design System v0.1 構築プラン
type: design-system
brand: fambox
version: 0.1
status: draft
...
owner: 宮川
phase: 構築プラン（DNA v1.0完成後にPhase A翻訳表へ）
related:
  - fambox/brand-dna/current.md
  - fam/brand-dna/current.md
---
...
| 0-2 | **視覚言語6軸の優先順位** | **Ascending 1位 → Propulsive 2位 → Co-driven 3位 → Scientific → Continuity → Pulsing**（Worksheet §1 確定 2026-04-20）| L4-1〜L4-6 |
