...
## Change Log
- v0.3-figma-sitemap (2026-05-14): Session #33 で sitemap variant (60:56) の Nav columns を 3 列 → **4 列**に再構築。PRODUCTS column (60:63) を clone して BUSINESS column (`129:123`) を 4 列目に追加（"法人向けプラン" / "導入事例" / "パートナー"）。**spec § Variants ↔ Liquid (`.footer-sitemap .footer__nav: 4cols`) ↔ Figma の三位一体完全達成**
...
## Sitemap variant 4 列構造（v0.3-figma-sitemap）

| Column | Heading | Links | Figma node |
|---|---|---|---|
| 1 | PRODUCTS | 商品一覧 / 定期便 / 法人プラン | `60:63` |
| 2 | COMPANY | 会社情報 / 事例 / ブログ | `60:68` |
| 3 | SUPPORT | FAQ / お問い合わせ / お知らせ | `60:73` |
| 4 | **BUSINESS** ★新規 | 法人向けプラン / 導入事例 / パートナー | `129:123` |

Liquid 側の Sitemap preset（`fambox-footer.liquid`）は ABOUT / PRODUCTS / SUPPORT / BUSINESS の組み合わせを default 値で持つが、エディタで自由に書き換え可能。Figma 側の見出しは既存日本語ストア構成に合わせて PRODUCTS / COMPANY / SUPPORT / BUSINESS とした。
