...
| DOCTRINE | 11 | Typography 1 / Anti-pattern 1 / 資料フォント 1 / Specificity 1 / Schema 型 1 / 印刷物Typo 1 / 色ゾーニング 1 / 3テイストモード 1 / ブロッキング+フルブリード+レイヤー 1 / B向けHero特大ジャンプは構造で 1 / **役割ドリブン設計+AI自己採点は過大 1** |
...
| **合計** | **38** | DOCTRINE-011（役割ドリブン設計＋AI自己採点は過大）は 2026-06-09 宮川さん v2 実査校正から追加 |
